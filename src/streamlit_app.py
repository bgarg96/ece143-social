...
option2 = st.selectbox('Find top Influencers in these subcategories', instagram.get_category_items(option1))
option3 = st.selectbox('Select Number of Influencers to display', (1,3,5,10))
