...
if __name__ == '__main__':
    ...
    my_expander5 = st.expander(
        label="Proportion of influencer in each category in a demographic")
    with my_expander5:
    ...
    my_expander8 = st.expander(
        label='Analysis of Top Influencers vs Subscribers')
    with my_expander8:
